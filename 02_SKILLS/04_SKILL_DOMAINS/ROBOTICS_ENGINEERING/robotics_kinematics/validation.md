# Validation Protocol: Robotics Kinematics

## Validation Summary
This document defines the validation gates, verification commands, and test suites for confirming the quality of outputs generated by the Robotics Kinematics skill.
...
- Verify file existence:
  - [ ] `templates/kinematics_model.py` exists and matches spec.
  - [ ] `templates/gait_profile.json` exists and matches spec.
