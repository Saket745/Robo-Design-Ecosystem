# Validation Protocol: PCB Design

## Validation Summary
This document defines the validation gates, verification commands, and test suites for confirming the quality of outputs generated by the PCB Design skill.
...
- Verify file existence:
  - [ ] `templates/control_board.kicad_pcb` exists and matches spec.
  - [ ] `templates/gerber_pack.zip` exists and matches spec.
