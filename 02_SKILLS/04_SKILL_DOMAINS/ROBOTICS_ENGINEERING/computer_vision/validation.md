# Validation Protocol: Computer Vision

## Validation Summary
This document defines the validation gates, verification commands, and test suites for confirming the quality of outputs generated by the Computer Vision skill.
...
- Verify file existence:
  - [ ] `templates/detection_node.py` exists and matches spec.
  - [ ] `templates/camera_calibration.yaml` exists and matches spec.
