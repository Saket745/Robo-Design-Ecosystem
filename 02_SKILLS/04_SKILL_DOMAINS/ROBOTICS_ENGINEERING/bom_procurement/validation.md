# Validation Protocol: BOM & Procurement

## Validation Summary
This document defines the validation gates, verification commands, and test suites for confirming the quality of outputs generated by the BOM & Procurement skill.
...
- Verify file existence:
  - [ ] `templates/bom_master.xlsx` exists and matches spec.
  - [ ] `templates/procurement_sources.csv` exists and matches spec.
