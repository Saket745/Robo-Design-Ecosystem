# Validation Protocol: Motor Control

## Validation Summary
This document defines the validation gates, verification commands, and test suites for confirming the quality of outputs generated by the Motor Control skill.
...
- Verify file existence:
  - [ ] `templates/motor_calibration.json` exists and matches spec.
  - [ ] `templates/pid_tuner.py` exists and matches spec.
