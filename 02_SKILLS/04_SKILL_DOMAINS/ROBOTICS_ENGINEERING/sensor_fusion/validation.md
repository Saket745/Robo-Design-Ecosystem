# Validation Protocol: Sensor Fusion

## Validation Summary
This document defines the validation gates, verification commands, and test suites for confirming the quality of outputs generated by the Sensor Fusion skill.
...
- Verify file existence:
  - [ ] `templates/ekf_node.py` exists and matches spec.
  - [ ] `templates/tf_broadcaster.cpp` exists and matches spec.
